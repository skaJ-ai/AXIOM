    ...
    blocks: [
      {
        paragraphs: [
          ...
          '실전 도입도 대개 같은 순서를 밟는다. 1단계는 회의록 요약, 번역, 초안화처럼 진입장벽이 낮은 비서형 활용과 작업 로그 축적, 2단계는 축적 자산을 retrieval과 RAG에 태워 팀 맥락 검색을 여는 단계, 3단계는 Python/CLI를 붙여 반복 실행을 자동화하는 단계다.',
        ],
      ...
      },
      {
        bullets: [
          ...
          '도입 사다리는 단순 활용 → 지식 검색 → 실행 자동화 순으로 설계하는 편이 안정적이다.',
        ],
        paragraphs: [
