...
const HERO_COPY = {
  ...
  label: 'AXIOM',
  subtitleFirstLine: 'AXIOM는 대화만으로 회사 표준 형식의 HR 보고서 초안을 만듭니다.',
...
const COMPARISON_ROWS: ComparisonRow[] = [
  {
    ...
    harp: '보고서 유형을 고르면 AXIOM가 먼저 질문합니다.',
    label: '시작할 때',
  },
  {
    gauss: '자유 대화라서 무엇을 빠뜨렸는지 모릅니다.',
    harp: '체크리스트가 내장되어 빠진 항목을 AXIOM가 추적합니다.',
    label: '빠지는 항목',
  },
  {
...
const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  ...
  {
    description:
      'AXIOM가 빠진 항목을 질문합니다. 답하다 보면 오른쪽 캔버스에 섹션별 초안이 실시간으로 쌓입니다.',
    step: '2',
    title: '대화로 채우기',
  },
  {
...
const TRUST_SIGNALS: TrustSignal[] = [
  {
    description:
      'AXIOM는 초안을 제안할 뿐입니다. draft -> final 승격은 반드시 담당자가 확인한 후에만 가능합니다.',
    title: '당신이 최종 검토합니다',
  },
  {
    description:
  ...
  {
    description:
      'AXIOM는 보고서 작성 단계만 도와줍니다. 기존 결재선, 공유 방식, 양식 규정은 바뀌지 않습니다.',
