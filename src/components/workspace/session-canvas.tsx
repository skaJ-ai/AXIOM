...
function SessionCanvas({ initialSession }: SessionCanvasProps) {
  ...
  const isSourcesTabActive = activeTab === 'sources';
        ...
        <div className="shrink-0 border-b border-[var(--color-border)] px-6 py-5">
          <div className="flex flex-col gap-5">
              ...
              <div className="flex max-w-3xl flex-col gap-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="max-w-2xl text-sm leading-6 text-[var(--color-text-secondary)]">
                    인터뷰 답변과 근거자료를 바탕으로 초안을 단계적으로 채웁니다.
                  </p>
                </div>
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-3 border-t border-[var(--color-border-subtle)] pt-4">
              ...
              <button
                className={`tab ${isSourcesTabActive ? 'active' : ''}`}
                onClick={handleSourcesTabClick}
                type="button"
              >
                근거자료
              </button>
                ...
                <>
                  ...
                  <section className="flex flex-col gap-4">
                    <div className="workspace-card-muted flex flex-col gap-2">
                      ...
                      <p className="text-sm leading-6 text-[var(--color-text-secondary)]">
                        같은 유형의 최근 산출물 최대 3건을 자동으로 참고합니다.
                      </p>
                    </div>
